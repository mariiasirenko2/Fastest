...
public final class ActivityTestDataBinding implements ViewBinding {
  ...
  private ActivityTestDataBinding(@NonNull LinearLayout rootView, @NonNull TextView testName) {
  ...
  public static ActivityTestDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTestDataBinding((LinearLayout) rootView, testName);
    }
